...
* `__add__(self, other)`: Перегруженный оператор сложения. Возвращает новый вектор, являющийся суммой текущего вектора и вектора `other`.

* `__sub__(self, other)`: Перегруженный оператор вычитания. Возвращает новый вектор, являющийся разностью текущего вектора и вектора `other`.

* `__mul__(self, scalar)`: Перегруженный оператор умножения. Возвращает новый вектор, полученный путем умножения текущего вектора на скаляр.
